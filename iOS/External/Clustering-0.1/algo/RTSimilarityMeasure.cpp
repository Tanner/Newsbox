/*
** RTSimilarityMeasure.cpp
** Login : Julien Lemoine <speedblue@happycoders.org>
** Started on  Sun Sep 17 19:12:42 2006 Julien Lemoine
** $Id$
** 
...
Algo::RTSimilarityMeasure::RTSimilarityMeasure(const std::vector<unsigned> &docCards,
						   unsigned nbDescriptors) :
  Algo::SimilarityMeasure(docCards, nbDescriptors)
{
}

Algo::RTSimilarityMeasure::~RTSimilarityMeasure()
{
}

double Algo::RTSimilarityMeasure::compute(const Cluster &c1, const Cluster &c2) const
{ 
...
double Algo::RTSimilarityMeasure::compute(unsigned docId1, unsigned docId2, unsigned inter) const
{
  double num = _getNbDescriptors() + 2.0 * inter - _getDocCard(docId1) - _getDocCard(docId2);
  double denum = _getNbDescriptors() - num;
  denum *= 2.0;
  denum += num;
