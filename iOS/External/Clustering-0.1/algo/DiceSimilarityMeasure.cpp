/*
** DiceSimilarityMeasure.cpp
** Login : Julien Lemoine <speedblue@happycoders.org>
** Started on  Sat Sep 16 21:10:56 2006 Julien Lemoine
** $Id$
** 
...
Algo::DiceSimilarityMeasure::DiceSimilarityMeasure(const std::vector<unsigned> &docCards,
						   unsigned nbDescriptors) :
  Algo::SimilarityMeasure(docCards, nbDescriptors)
{
}

Algo::DiceSimilarityMeasure::~DiceSimilarityMeasure()
{
}

double Algo::DiceSimilarityMeasure::compute(const Cluster &c1, const Cluster &c2) const
{ 
  ...
  return 2.0 * dotProduct / maximum;
}

double Algo::DiceSimilarityMeasure::compute(unsigned docId1, unsigned docId2, unsigned inter) const
{
  double num = 2.0 * inter;
  double denum = _getDocCard(docId1) + _getDocCard(docId2);
  return num / denum;
}
