/*
** SS2SimilarityMeasure.cpp
** Login : Julien Lemoine <speedblue@happycoders.org>
** Started on  Sun Sep 17 19:19:02 2006 Julien Lemoine
** $Id$
** 
...
Algo::SS2SimilarityMeasure::SS2SimilarityMeasure(const std::vector<unsigned> &docCards,
						   unsigned nbDescriptors) :
  Algo::SimilarityMeasure(docCards, nbDescriptors)
{
}

Algo::SS2SimilarityMeasure::~SS2SimilarityMeasure()
{
}

double Algo::SS2SimilarityMeasure::compute(const Cluster &c1, const Cluster &c2) const
{ 
...
double Algo::SS2SimilarityMeasure::compute(unsigned docId1, unsigned docId2, unsigned inter) const
{
  double denum = _getDocCard(docId1) + _getDocCard(docId2) - 2.0 * inter;
  denum *= 2.0;
  denum += inter;
  double num = inter;
